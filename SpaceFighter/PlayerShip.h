...
public:
    ...
    void Initialize(Level* pLevel, const Vector2& startPosition, ResourceManager& resourceManager);
    ...
    virtual void Initialize(Level* pLevel, const Vector2& startPosition);
...
private:
    ...
    std::vector<Texture*> m_lifeTextures;
